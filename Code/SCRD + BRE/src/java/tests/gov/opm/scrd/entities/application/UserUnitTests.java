 ...
 * <ul>
 * <li>add getter and setter test for field defaultTabAccountId</li>
 * </ul>
 * </p>
...
public class UserUnitTests {
    ...
    public void testCtor() {
        ...
        assertNull("'defaultTabAccountId' should be correct.", TestsHelper.getField(instance, "defaultTabAccountId"));
    }
    ...
    /**
     * <p>
     * Accuracy test for the method <code>getSupervisorId()</code>.<br>
     * The value should be properly retrieved.
     * </p>
     */
    @Test
    public void test_getSupervisorId() {
        Long value = 1L;
        instance.setSupervisorId(value);

        assertSame("'getSupervisorId' should be correct.",
            value.longValue(), instance.getSupervisorId().longValue());
    }

    /**
     * <p>
     * Accuracy test for the method <code>setSupervisorId(Long supervisorId)</code>.<br>
     * The value should be properly set.
     * </p>
     */
    @Test
    public void test_setSupervisorId() {
        Long value = 1L;
        instance.setSupervisorId(value);

        assertSame("'setSupervisorId' should be correct.",
            value, TestsHelper.getField(instance, "supervisorId"));
    }

    /**
     * <p>
     * Accuracy test for the method <code>getDefaultTabAccountId()</code>.<br>
     * The value should be properly retrieved.
     * </p>
     *
     ...
     */
    @Test
    public void test_getDefaultTabAccountId() {
        Long value = 1L;
        instance.setDefaultTabAccountId(value);

        assertSame("'getDefaultTabAccountId' should be correct.",
            value.longValue(), instance.getDefaultTabAccountId().longValue());
    }

    /**
     * <p>
     * Accuracy test for the method <code>getDefaultTabAccountId(Long defaultTabAccountId)</code>.<br>
     * The value should be properly set.
     * </p>
     *
     * @since 1.1 (OPM - SCRD - Frontend Account Module Assembly 1.0)

...
/**
 * Represents the PaymentAppliance entity.
 * It's mutable and not thread safe.
 * 
 * Changed log:
 * This entity is added in the  OPM - Frontend - Payments Module Assembly
 * 
 * @author faeton, TCSASSEMBLER
 * @version 1.0
 */
public class PaymentAppliance extends NamedEntity {
    /**
     * Create the instance. Empty constructor.
     */
    public PaymentAppliance() {
    }

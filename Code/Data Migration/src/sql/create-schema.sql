...
CREATE TABLE opm.account_holder (
  ...
  city_of_employment VARCHAR(128) NOT NULL ,
  state_of_employment_id BIGINT NOT NULL,
...
-- Table fers_deposit
-- -----------------------------------------------------
CREATE TABLE opm.fers_deposit (
  id BIGSERIAL NOT NULL,
  account_id BIGINT NOT NULL,
  calculation_version_id BIGINT NOT NULL,
  PRIMARY KEY (id) ,
  CONSTRAINT fk_fers_deposit_account
    FOREIGN KEY (account_id )
    REFERENCES opm.account (id )
    ON DELETE CASCADE
    ON UPDATE NO ACTION,
  CONSTRAINT fk_fers_deposit_calculation_version
...
-- -----------------------------------------------------
-- Table fers_redeposit
-- -----------------------------------------------------
CREATE TABLE opm.fers_redeposit (
  id BIGSERIAL NOT NULL,
  account_id BIGINT NOT NULL,
  calculation_version_id BIGINT NOT NULL,
  PRIMARY KEY (id) ,
  CONSTRAINT fk_fers_redeposit_account
    FOREIGN KEY (account_id )
    REFERENCES opm.account (id )
    ON DELETE CASCADE
    ON UPDATE NO ACTION,
  CONSTRAINT fk_fers_redeposit_calculation_version
    FOREIGN KEY (calculation_version_id )
    REFERENCES opm.calculation_version (id )
    ON DELETE CASCADE
    ON UPDATE NO ACTION);
...
CREATE TABLE opm.payment (
  ...
  approval_user VARCHAR(128) NOT NULL ,
  approval_status VARCHAR(128) NULL,
  approval_reason VARCHAR(128) NULL,
...
-- -----------------------------------------------------
-- Table fers_deposit_history
-- -----------------------------------------------------
CREATE TABLE opm.fers_deposit_history (
  id BIGINT NOT NULL,
  account_id BIGINT NOT NULL,
  calculation_version_id BIGINT NOT NULL ,
  action_timestamp TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
-- -----------------------------------------------------
-- Table fers_redeposit_history
-- -----------------------------------------------------
CREATE TABLE opm.fers_redeposit_history (
  id BIGINT NOT NULL,
  account_id BIGINT NOT NULL,
  calculation_version_id BIGINT NOT NULL ,
  action_timestamp TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE opm.payment_history (
  ...
  ssn VARCHAR(128) NULL ,
  claimant VARCHAR(128) NULL ,
  claimant_birthday VARCHAR(128) NULL ,
  import_id VARCHAR(128) NULL ,
  sequence INT NOT NULL ,
  transaction_date TIMESTAMP NULL ,
  status_date TIMESTAMP NULL ,

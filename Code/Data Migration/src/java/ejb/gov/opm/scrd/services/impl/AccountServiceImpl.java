...
public class AccountServiceImpl extends BaseService implements AccountService {
    ...
    /**
     * Saves the deposit calculation version for the account.
     *
     * @param accountId
     ...
     */
    @TransactionAttribute(TransactionAttributeType.REQUIRED)
    public void saveFERSDepositCalculationVersion(long accountId, CalculationVersion calculationVersion)
        throws OPMException {
        String signature = CLASS_NAME
            + "#saveFERSDepositCalculationVersion(long accountId, CalculationVersion calculationVersion)";
        Logger logger = getLogger();
        ...
        try {
            ...
            account.getFersDepositCalculationVersions().add(calculationVersion);
    ...
    /**
     * Saves the redeposit calculation version for the account.
     *
     * @param accountId
     *            the id of account to save calculation version.
     * @param calculationVersion
     ...
     */
    @TransactionAttribute(TransactionAttributeType.REQUIRED)
    public void saveFERSRedepositCalculationVersion(long accountId, CalculationVersion calculationVersion)
        throws OPMException {
        String signature = CLASS_NAME
            + "#saveFERSRedepositCalculationVersion(long accountId, CalculationVersion calculationVersion)";
        Logger logger = getLogger();
        ...
        try {
            ...
            account.getFersRedepositCalculationVersions().add(calculationVersion);
    ...
    public void saveBillings(long accountId, List<Billing> billings) throws OPMException {
        ...
        try {
            ...
            for (CalculationVersion version : account.getFersDepositCalculationVersions()) {
            ...
            if (calculationDate == null) {
                for (CalculationVersion version : account.getFersRedepositCalculationVersions()) {
                    if (version.getCalculationResult().isOfficial()) {
                        calculationDate = version.getCalculationDate();
                        break;
                    }

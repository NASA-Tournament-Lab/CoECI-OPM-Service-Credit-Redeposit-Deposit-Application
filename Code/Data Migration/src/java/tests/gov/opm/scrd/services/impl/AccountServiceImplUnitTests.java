...
public class AccountServiceImplUnitTests extends BasePersistenceTests {
    ...
    public void test_create() throws Exception {
        ...
        assertEquals("'create' should be correct.", account.getFersDepositCalculationVersions().size(),
            retrievedAccount.getFersDepositCalculationVersions().size());
    }
    ...
    public void test_get_2() throws Exception {
        ...
        assertEquals("'get' should be correct.", account.getFersDepositCalculationVersions().size(), res
            .getFersDepositCalculationVersions().size());
    }
    ...
    public void test_getByClaimNumber_2() throws Exception {
        ...
        assertEquals("'getByClaimNumber' should be correct.", account.getFersDepositCalculationVersions().size(), res
            .getFersDepositCalculationVersions().size());
    }
    ...
    /**
     * <p>
     * Accuracy test for the method <code>saveFERSDepositCalculationVersion(long accountId,
     ...
     */
    @Test
    public void test_saveFERSDepositCalculationVersion() throws Exception {
        entityManager.getTransaction().begin();
        instance.create(account);
        entityManager.getTransaction().commit();
        entityManager.clear();
        ...
        entityManager.getTransaction().begin();
        instance.saveFERSDepositCalculationVersion(account.getId(), calculationVersion);
        entityManager.getTransaction().commit();
        entityManager.clear();

        Account retrievedAccount = entityManager.find(Account.class, account.getId());

        assertEquals("'saveFERSDepositCalculationVersion' should be correct.", 1, retrievedAccount
            .getFersDepositCalculationVersions().size());
        assertTrue("'saveFERSDepositCalculationVersion' should be correct.", retrievedAccount
            .getFersDepositCalculationVersions().get(0).getId() > 0);
    }

    /**
     * <p>
     * Failure test for the method <code>saveFERSDepositCalculationVersion(long accountId,
     ...
     */
    @Test(expected = IllegalArgumentException.class)
    public void test_saveFERSDepositCalculationVersion_accountIdNegative() throws Exception {
        instance.saveFERSDepositCalculationVersion(-1, calculationVersion);
    }
     ...
     */
    @Test(expected = IllegalArgumentException.class)
    public void test_saveFERSDepositCalculationVersion_accountIdZero() throws Exception {
        instance.saveFERSDepositCalculationVersion(0, calculationVersion);
    }
     ...
     */
    @Test(expected = IllegalArgumentException.class)
    public void test_saveFERSDepositCalculationVersion_calculationVersionNull() throws Exception {
        instance.saveFERSDepositCalculationVersion(1, null);
    }
     ...
     */
    @Test(expected = EntityNotFoundException.class)
    public void test_saveFERSDepositCalculationVersion_accountNotExist() throws Exception {
        instance.saveFERSDepositCalculationVersion(Long.MAX_VALUE, calculationVersion);
    }

    /**
     * <p>
     * Accuracy test for the method <code>saveFERSRedepositCalculationVersion(long accountId,
     * CalculationVersion calculationVersion)</code>.<br>
     * The result should be correct.
     * </p>
     *
     ...
     */
    @Test
    public void test_saveFERSRedepositCalculationVersion() throws Exception {
        entityManager.getTransaction().begin();
        instance.create(account);
        entityManager.getTransaction().commit();
        entityManager.clear();
        ...
        entityManager.getTransaction().begin();
        instance.saveFERSRedepositCalculationVersion(account.getId(), calculationVersion);
        entityManager.getTransaction().commit();
        entityManager.clear();

        Account retrievedAccount = entityManager.find(Account.class, account.getId());

        assertEquals("'saveFERSRedepositCalculationVersion' should be correct.", 1, retrievedAccount
            .getFersRedepositCalculationVersions().size());
        assertTrue("'saveFERSRedepositCalculationVersion' should be correct.", retrievedAccount
            .getFersRedepositCalculationVersions().get(0).getId() > 0);
    }

    /**
     * <p>
     * Failure test for the method <code>saveFERSRedepositCalculationVersion(long accountId,
     * CalculationVersion calculationVersion)</code> with accountId is negative.<br>
     * <code>IllegalArgumentException</code> is expected.
     * </p>
     *
     ...
     */
    @Test(expected = IllegalArgumentException.class)
    public void test_saveFERSRedepositCalculationVersion_accountIdNegative() throws Exception {
        instance.saveFERSRedepositCalculationVersion(-1, calculationVersion);
    }
     ...
     */
    @Test(expected = IllegalArgumentException.class)
    public void test_saveFERSRedepositCalculationVersion_accountIdZero() throws Exception {
        instance.saveFERSRedepositCalculationVersion(0, calculationVersion);
    }
     ...
     */
    @Test(expected = IllegalArgumentException.class)
    public void test_saveFERSRedepositCalculationVersion_calculationVersionNull() throws Exception {
        instance.saveFERSRedepositCalculationVersion(1, null);
    }
     ...
     */
    @Test(expected = EntityNotFoundException.class)
    public void test_saveFERSRedepositCalculationVersion_accountNotExist() throws Exception {
        instance.saveFERSRedepositCalculationVersion(Long.MAX_VALUE, calculationVersion);
    }
    ...
    public void test_deleteCalculationVersion() throws Exception {
        ...
        long calculationVersionId = retrievedAccount.getFersDepositCalculationVersions().get(0).getId();
        entityManager.clear();
        entityManager.getTransaction().begin();

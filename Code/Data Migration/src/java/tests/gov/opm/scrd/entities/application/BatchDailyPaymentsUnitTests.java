...
public class BatchDailyPaymentsUnitTests {
    ...
    /**
     * <p>
     * Accuracy test for the method <code>getAuditBatchLogId()</code>.<br>
     * The value should be properly retrieved.
     * </p>
     */
    @Test
    public void test_getAuditBatchLogId() {
        Long value = 1L;
        instance.setAuditBatchLogId(value);

        assertEquals("'getAuditBatchLogId' should be correct.",
            value, instance.getAuditBatchLogId());
    }

    /**
     * <p>
     * Accuracy test for the method <code>setAuditBatchLogId(Long auditBatchLogId)</code>.<br>
     * The value should be properly set.
     * </p>
     */
    @Test
    public void test_setAuditBatchLogId() {
        Long value = 1L;
        instance.setAuditBatchLogId(value);

        assertEquals("'setAuditBatchLogId' should be correct.",
            value, TestsHelper.getField(instance, "auditBatchLogId"));
    }

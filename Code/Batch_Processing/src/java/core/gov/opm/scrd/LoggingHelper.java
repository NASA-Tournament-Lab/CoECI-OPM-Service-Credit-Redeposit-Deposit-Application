 ...
 * <ol>
 * <li>added toString handling for byte array</li>
 * </ol>
 * </p>
 *
...
public class LoggingHelper {
    ...
    /**
     * Logs for entrance into public methods at
    ...
    public static void logEntrance(Logger logger, String signature,
        ...
        sb.append(truncate(String.format(MESSAGE_ENTRANCE, signature),
                MAX_SIGNATURE));
        sb.append(truncate(toString(paramNames, params, MAX_ARGUMENTS),
                MAX_ARGUMENTS));
    ...
    /**
     * Logs for exit from public methods at
     * <code>DEBUG</code> level.
     *
     * @param logger the log service.
    ...
    public static void logExit(Logger logger, String signature, Object[] value) {
        ...
        StringBuilder sb = new StringBuilder();
        sb.append(truncate(String.format(MESSAGE_EXIT, signature),
                MAX_SIGNATURE));
        if (value != null) {
            sb.append(truncate(" Output parameter : " + toString(value[0]),
                    MAX_ARGUMENTS));
        }
        logger.debug(sb.toString());
    }
    ...
    /**
     * Logs the given exception and message at
    ...
    public static <T extends Throwable> T logException(Logger logger,
        ...
        if (logger != null) {
            ...
            logger.error(truncate(
                    String.format(MESSAGE_ERROR,
                    signature + " " + sw.toString()), MAX_EXCEPTION));
        }
        return e;
    }
    ...
    static String toString(Object obj) {
        ...
        if (obj instanceof InterestCalculationResponse) {
            ...
            str.append("extendedServicePeriods:"
                    + toString(response.getExtendedServicePeriods()));
            str.append("}");
            return str.toString();
            ...
            StringBuffer str = new StringBuffer("{");
            str.append("extendedServicePeriods:"
                    + toString(request.getExtendedServicePeriods()) + ",");
            str.append("interestCalculatedToDate:"
                    + toString(request.getInterestCalculatedToDate()));
            str.append("}");
            return str.toString();
            ...
            byte[] arr = (byte[]) obj;
            return "Binary Content[" + arr.length + "]";
        } else {

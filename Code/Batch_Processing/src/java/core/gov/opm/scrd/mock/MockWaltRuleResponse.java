 ...
 * @version 1.0
 */
public class MockWaltRuleResponse implements RuleResponse {
    /**
    ...
    /**
     * Represents the error description. It is accessible by getter and modified by setter. It can be any

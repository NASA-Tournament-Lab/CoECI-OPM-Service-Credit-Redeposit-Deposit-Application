...
public class ApprovalServiceImpl extends BaseService implements ApprovalService {
    ...
    private static final String JPQL_QUERY_PENDING_PAYMENT = "SELECT e FROM Payment e"
        + " WHERE e.deleted = false AND e.paymentType = 'PENDING_PAYMENT' AND e.approvalUser = :approvalUser";
     ...
     * </p>
     */
    private static final String JPQL_QUERY_PAYMENT_COUNT_BY_TYPE = "SELECT COUNT(e) FROM Payment e"
        + " WHERE e.deleted = false AND e.approvalUser = :approvalUser AND e.paymentType = :paymentType";

    /**
     * <p>
     * Represents the JPQL to query Payment count.
     * </p>
     */
    private static final String JPQL_QUERY_PAYMENT_COUNT = "SELECT COUNT(e) FROM Payment e"
        + " WHERE e.deleted = false AND e.approvalUser = :approvalUser";
    ...
    public ApprovalItemSummary getApprovalSummary(String approver) throws OPMException {
        ...
        try {
            ...
            result.setPendingPaymentCount(((Number) entityManager.createQuery(JPQL_QUERY_PAYMENT_COUNT_BY_TYPE)
                        .setParameter("approvalUser", approver)
                        .setParameter("paymentType", PaymentType.PENDING_PAYMENT)
                        .getSingleResult()).intValue());

            result.setInterestAdjustmentCount(((Number) entityManager.createQuery(JPQL_QUERY_PAYMENT_COUNT_BY_TYPE)
                        .setParameter("approvalUser", approver)
                        .setParameter("paymentType", PaymentType.INTEREST_ADJUSTMENT)
                        .getSingleResult()).intValue());

            result.setPaymentMoveCount(((Number) entityManager.createQuery(JPQL_QUERY_PAYMENT_COUNT_BY_TYPE)
                        .setParameter("approvalUser", approver)
                        .setParameter("paymentType", PaymentType.PAYMENT_MOVE)
                        .getSingleResult()).intValue());

            result.setTotalCount(((Number) entityManager.createQuery(JPQL_QUERY_PAYMENT_COUNT)
                        .setParameter("approvalUser", approver)
                        .getSingleResult()).intValue());
    ...
    public List<PendingPayment> getPendingPayments(String approver) throws OPMException {
        ...
        try {
            List<Payment> payments = getEntityManager().createQuery(JPQL_QUERY_PENDING_PAYMENT, Payment.class)
                .setParameter("approvalUser", approver).getResultList();
    ...
    public void approvePendingPayments(String approver, long[] pendingPaymentIds) throws OPMException {
        ...
        approvePayments(signature, approver, pendingPaymentIds, "pendingPaymentIds");
    }
    ...
    public void disapprovePendingPayments(String approver, long[] pendingPaymentIds, String reason)
        ...
        disapprovePayments(signature, approver, pendingPaymentIds, reason, "pendingPaymentIds");
    }
    ...
    public void approveInterestAdjustments(String approver, long[] interestAdjustmentIds) throws OPMException {
        ...
        approvePayments(signature, approver, interestAdjustmentIds, "interestAdjustmentIds");
    }
    ...
    public void disapproveInterestAdjustments(String approver, long[] interestAdjustmentIds, String reason)
        ...
        disapprovePayments(signature, approver, interestAdjustmentIds, reason, "interestAdjustmentIds");
    }
    ...
    public void approvePaymentMoves(String approver, long[] paymentMoveIds) throws OPMException {
        ...
        approvePayments(signature, approver, paymentMoveIds, "paymentMoveIds");
    }
    ...
    public void disapprovePaymentMoves(String approver, long[] paymentMoveIds, String reason) throws OPMException {
        ...
        disapprovePayments(signature, approver, paymentMoveIds, reason, "paymentMoveIds");
    }
    ...
    private void disapprovePayments(String signature, String approver, long[] paymentIds, String reason,
        String paymentIdsName) throws OPMException {
        Logger logger = getLogger();

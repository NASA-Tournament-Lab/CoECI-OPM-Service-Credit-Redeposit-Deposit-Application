 ...
 * @version 1.0
 */
public class UserRolePermissionsReportRequest implements ReportRequest {

    /**
     * Represents the flag indicates if the current account is included. It is accessible by getter and modified by
    ...
    /**
     * Creates a new instance of the {@link UserRolePermissionsReportRequest} class.
     */
    public UserRolePermissionsReportRequest() {
    }

    /**
     * Gets the flag indicates if the current account is included.
     *
     * @return the flag indicates if the current account is included.
     */
    ...
    /**
     * Sets the flag indicates if the current account is included.
     *
     * @param includeCurrentAccount
     *         the flag indicates if the current account is included.
     */

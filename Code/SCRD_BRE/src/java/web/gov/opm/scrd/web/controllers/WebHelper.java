...
public final class WebHelper {
     ...
     */
    public static final String SECURITY_SERVICE_JNDI = "java:app/opm-scrd-ejb/SecurityServiceImpl!"
            + "gov.opm.scrd.services.impl.SecurityServiceImpl";
    /**
     * JNDI binding for the user service.
     */
    public static final String USER_SERVICE_JNDI = "java:app/opm-scrd-ejb/UserServiceImpl!"
            + "gov.opm.scrd.services.impl.UserServiceImpl";
    /**
     * JNDI binding for the lookup service.
     */
    static final String LOOKUP_SERVICE_JNDI = "java:app/opm-scrd-ejb/LookupServiceImpl!"
            + "gov.opm.scrd.services.impl.LookupServiceImpl";
    /**
     * JNDI binding for the account service.
     */
    static final String ACCOUNT_SERVICE_JNDI = "java:app/opm-scrd-ejb/AccountServiceImpl!"
            + "gov.opm.scrd.services.impl.AccountServiceImpl";

    /**
     * JNDI binding for the letter service.
     */
    static final String LETTER_SERVICE_JNDI = "java:app/opm-scrd-ejb/LetterServiceImpl!"
            + "gov.opm.scrd.services.impl.LetterServiceImpl";
    
    /**
     * JNDI binding for the letter service.
     */
    static final String REFERENCE_SERVICE_JNDI = "java:app/opm-scrd-ejb/ReferenceServiceImpl!"
            + "gov.opm.scrd.services.impl.ReferenceServiceImpl";
    

    /**
     * JNDI binding for the suspension service.
     */
    static final String SUSPENSION_SERVICE_JNDI = "java:app/opm-scrd-ejb/SuspensionServiceImpl!"
            + "gov.opm.scrd.services.impl.SuspensionServiceImpl";
    /**
     * JNDI binding for the approval service.
     */
    static final String APPROVAL_SERVICE_JNDI = "java:app/opm-scrd-ejb/ApprovalServiceImpl!"
            + "gov.opm.scrd.services.impl.ApprovalServiceImpl";
    /**
     * JNDI binding for the service announcement service.
     */
    static final String SERVICE_ANNOUNCEMENT_SERVICE_JNDI = "java:app/opm-scrd-ejb/ServiceAnnouncementServiceImpl!"
            + "gov.opm.scrd.services.impl.ServiceAnnouncementServiceImpl";
    /**
     * JNDI binding for the audit service.
     */
    static final String AUDIT_SERVICE_JNDI = "java:app/opm-scrd-ejb/AuditServiceImpl!"
     ...
     */
    static final String CALCULATION_EXECUTION_SERVICE_JNDI = "java:app/opm-scrd-ejb/CalculationExecutionServiceImpl!"
     ...
     */
    static final String PAYMENT_SERVICE_JNDI = "java:app/opm-scrd-ejb/PaymentServiceImpl!"
     ...
     * @since OPM - Frontend - Miscellaneous Module Assembly
     */
    static final String BATCH_PRINT_OUT_ARCHIVE_SERVICE_JNDI = "java:app/opm-scrd-ejb/BatchPrintoutArchiveServiceImpl!"
     ...
     * @since OPM - Frontend - Miscellaneous Module Assembly
     */
    static final String SERVICE_CREDIT_PREFERENCE_SERVICE_JNDI = "java:app/opm-scrd-ejb/ServiceCreditPreferenceServiceImpl!"
     ...
     * @since OPM - Frontend - Miscellaneous Module Assembly
     */
    static final String REPORT_GENERATION_DATA_SERVICE_JNDI = "java:app/opm-scrd-ejb/ReportGenerationDataServiceImpl!"
     ...
     * @since OPM - Frontend - Miscellaneous Module Assembly
     */
    static final String HELP_SERVICE_JNDI = "java:app/opm-scrd-ejb/HelpServiceImpl!"

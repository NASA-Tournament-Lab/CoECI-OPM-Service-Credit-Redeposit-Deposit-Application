...
public class EntityNotFoundExceptionUnitTests {
    ...
    /**
     * <p>
     * <code>EntityNotFoundException</code> should be subclass of <code>OPMException</code>.
     * </p>
     */
    @Test
    public void testInheritance() {
        assertTrue("EntityNotFoundException should be subclass of OPMException.",
            EntityNotFoundException.class.getSuperclass() == OPMException.class);
    }

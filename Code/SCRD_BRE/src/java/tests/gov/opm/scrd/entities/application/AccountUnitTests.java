 ...
 * <ul>
 * <li>Modifiy test case for getter and setter of lastAction</li>
 * <li>Add test case for getter and setter of lastActionDate</li>
 * </ul>
 * </p>
 *
...
public class AccountUnitTests {
    ...
    public void testCtor() {
        ...
        assertNull("'calculationVersions' should be correct.",
            TestsHelper.getField(instance, "calculationVersions"));
    ...
    /**
     * <p>
     * Accuracy test for the method <code>setCalculationVersions(List&lt;CalculationVersion&gt;
     * calculationVersions)</code>.<br>
     * The value should be properly set.
     * </p>
     */
    @Test
    ...
    public void test_getLastAction() {
        String value = "provide final fix";
    ...
    /**
     * <p>
     * Accuracy test for the method <code>setLastAction(String lastAction)</code>.<br>
     * The value should be properly set.
     * </p>
     *
     * @since 1.2 (OPM - Data Migration - Entities Update Module Assembly 1.0)
    ...
    /**
     * <p>
     * Accuracy test for the method <code>getLastActionDate()</code>.<br>
     * The value should be properly retrieved.
     * </p>
     *
     ...
     */
    @Test
    public void test_getLastActionDate() {
        Date value = new Date();
        instance.setLastActionDate(value);

        assertSame("'getLastActionDate' should be correct.",
            value, instance.getLastActionDate());
    }

    /**
     * <p>
     * Accuracy test for the method <code>setLastActionDate(Date lastActionDate)</code>.<br>
     * The value should be properly set.
     * </p>
     *
     * @since 1.3 (OPM - SCRD - Frontend Account Module Assembly 1.0)
     */
    @Test
    public void test_setLastActionDate() {
        Date value = new Date();
        instance.setLastActionDate(value);

        assertSame("'setLastActionDate' should be correct.",
            value, TestsHelper.getField(instance, "lastActionDate"));
    }

...
CREATE TABLE opm.account (
  ...
  balance DECIMAL(40,6) NULL ,
  billing_summary_id BIGINT NULL,
  account_confirmation_validation_id BIGINT NULL,
  total_deposit DECIMAL(40,6) NULL,
  total_redeposit DECIMAL(40,6) NULL,
  total_var_redeposit DECIMAL(40,6) NULL,
  total_non_deposit DECIMAL(40,6) NULL,
  total_fers_w DECIMAL(40,6) NULL,
  acc_int_dep DECIMAL(40,6) NULL,
  acc_int_rdep DECIMAL(40,6) NULL,
  acc_int_non_dep DECIMAL(40,6) NULL,
  acc_int_var_rdep DECIMAL(40,6) NULL,
  acc_int_fers DECIMAL(40,6) NULL,
  tot_pay_d DECIMAL(40,6) NULL,
  tot_pay_r DECIMAL(40,6) NULL,
  tot_pay_n DECIMAL(40,6) NULL,
  tot_pay_vr DECIMAL(40,6) NULL,
  tot_pay_fers DECIMAL(40,6) NULL,
...
CREATE TABLE opm.billing (
  ...
  deleted BOOLEAN NOT NULL,
  name VARCHAR(128) NOT NULL ,
  initial_billing DECIMAL(40,6) NOT NULL ,
  additional_interest DECIMAL(40,6) NOT NULL ,
  total_payments DECIMAL(40,6) NOT NULL ,
  balance DECIMAL(40,6) NOT NULL ,
...
CREATE TABLE opm.summary_data (
  id BIGSERIAL NOT NULL,
  deleted BOOLEAN NOT NULL,
  total_payments_required DECIMAL(40,6) NOT NULL ,
  total_initial_interest DECIMAL(40,6) NOT NULL ,
  total_payments_applied DECIMAL(40,6) NOT NULL ,
  total_balance DECIMAL(40,6) NOT NULL ,
  PRIMARY KEY (id));
...
-- -----------------------------------------------------
-- Table deduction_calculation_detail
-- -----------------------------------------------------
CREATE TABLE opm.deduction_calculation_detail(
    id BIGSERIAL NOT NULL,
    deleted BOOLEAN NOT NULL,
    deduction_rate DOUBLE PRECISION NULL,
    running_deductions DECIMAL(40,6) NULL,
    total_running_earnings DECIMAL(40,6) NULL,
    total_running_deductions DECIMAL(40,6) NULL,
    PRIMARY KEY (id)
);
...
CREATE TABLE opm.calculation (
  ...
  CONSTRAINT fk_calculation_agency_code
    ...
    ON DELETE CASCADE
    ON UPDATE NO ACTION,
  CONSTRAINT fk_deduction_calculation_detail
    FOREIGN KEY (deduction_calculation_detail_id )
    REFERENCES opm.deduction_calculation_detail (id )
    ON DELETE CASCADE
    ON UPDATE NO ACTION,
  CONSTRAINT fk_calculation_calculation_result
    FOREIGN KEY (calculation_result_id )
    REFERENCES opm.calculation_result (id )
    ON DELETE CASCADE
    ON UPDATE NO ACTION,
...
CREATE TABLE opm.calculation_result_item (
  ...
  period_type_id BIGINT NOT NULL,
  deduction_amount DECIMAL(40,6) NOT NULL ,
  total_interest DECIMAL(40,6) NOT NULL ,
  payment_applied DECIMAL(40,6) NOT NULL ,
  balance DECIMAL(40,6) NOT NULL ,
  calculation_result_id BIGINT NULL,
...
CREATE TABLE opm.intermediate_result (
  id BIGSERIAL NOT NULL,
  deleted BOOLEAN NOT NULL,
  intermediate_amount DECIMAL(40,6) NULL,
  intermediate_rate DOUBLE PRECISION NULL,
  intermediate_begin_date TIMESTAMP NULL ,
  intermediate_end_date TIMESTAMP NULL,
  balance_with_interest DECIMAL(40,6) NULL,
  interest_calculated_to_date TIMESTAMP NULL,
  before_balance_with_interest DECIMAL(40,6) NULL,
  start_year_factor DECIMAL(40,6) NULL,
  period_in_days INT NULL,
  period_begin_date TIMESTAMP NULL,
  period_end_date TIMESTAMP NULL,
  period_type VARCHAR(128) NULL,
  retirement_type VARCHAR(128) NULL,
  intermediate_rate2 DOUBLE PRECISION NULL,
  period_in_days2 INT NULL,
  composite_rate1 DECIMAL(40,6) NULL,
  composite_rate2 DECIMAL(40,6) NULL,
  interest_calculation_year INT NULL,
  interest_accrual_date TIMESTAMP NULL,
...
CREATE TABLE opm.redeposit (
  ...
  deposit DECIMAL(40,6) NOT NULL ,
  interest DECIMAL(40,6) NOT NULL ,
  total DECIMAL(40,6) NOT NULL ,
  calculation_result_id BIGINT NULL,
  PRIMARY KEY (id) ,
...
CREATE TABLE opm.payment (
  ...
  transaction_key VARCHAR(128) NULL ,
  ach BOOLEAN NULL ,
  account_balance DECIMAL(40,6) NULL ,
  ...
  master_account_balance DECIMAL(40,6) NULL ,
  master_account_id BIGINT NULL,
  pre_deposit_amount DECIMAL(40,6) NULL ,
  pre_redeposit_amount DECIMAL(40,6) NULL ,
  post_deposit_amount DECIMAL(40,6) NULL ,
  post_redeposit_amount DECIMAL(40,6) NULL ,
...
CREATE TABLE opm.invoice (
  ...
  deposit DECIMAL(40,6) NULL,
  redeposit DECIMAL(40,6) NULL,
  tot_var_redeposit DECIMAL(40,6) NULL,
  non_ded DECIMAL(40,6) NULL,
  fers_w DECIMAL(40,6) NULL,
  acc_int_dep DECIMAL(40,6) NULL,
  acc_int_rdep DECIMAL(40,6) NULL,
  acc_int_non_dep DECIMAL(40,6) NULL,
  acc_int_var_rdep DECIMAL(40,6) NULL,
...
CREATE TABLE opm.payment_interest_detail (
  ...
  calculated_interest DECIMAL(40,6) NULL,
  last_pay_to_eoy_factor DECIMAL(40,6) NULL,
  partial_to_this_factor DECIMAL(40,6) NULL,
  this_interest_rate DECIMAL(40,6) NULL,

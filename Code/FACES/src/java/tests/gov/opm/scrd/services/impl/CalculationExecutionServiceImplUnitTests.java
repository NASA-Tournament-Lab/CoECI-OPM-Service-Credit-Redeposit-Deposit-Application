 ...
 * <ul>
 * <li>Modify test_runCalculation_1()/test_runCalculation_2()/test_runCalculation_3() methods
 * to pass in a specific interest calculation to date</li>
 * </ul>
 * </p>
 *
 * <p>
 ...
 * <ul>
 * <li>Modify setUp(), test_runCalculation_1, test_runCalculation_2, test_runCalculation_3 to make fields of
 * calculations match values in the rules.</li>
 * </ul>
 * </p>
 *
...
public class CalculationExecutionServiceImplUnitTests extends BasePersistenceTests {
    ...
    public void setUp() throws Exception {
        ...
        TestsHelper.setField(instance, "fersRetirementType", fersRetirementType);
    ...
    public void test_runCalculation_1() throws Exception {
        ...
        for (Redeposit redeposit : redeposits) {
            assertEquals("'runCalculation' should be correct.", 0, redeposit.getDeposit().intValue());
            assertEquals("'runCalculation' should be correct.", 0, redeposit.getInterest().intValue());
            assertEquals("'runCalculation' should be correct.", 0, redeposit.getTotal().intValue());
        }
        for (Dedeposit dedeposit : dedeposits) {
            assertEquals("'runCalculation' should be correct.", 0, dedeposit.getDeposit().intValue());
            assertEquals("'runCalculation' should be correct.", 0, dedeposit.getInterest().intValue());
            assertEquals("'runCalculation' should be correct.", 0, dedeposit.getTotal().intValue());
        }
    ...
    public void test_runCalculation_2() throws Exception {
        ...
        assertEquals("'runCalculation' should be correct.", 4, redeposits.size());
        assertEquals("'runCalculation' should be correct.", 5, dedeposits.size());
        assertSame("'runCalculation' should be correct.",
            successCalculationStatus, res.getCalculationStatus());
        ...
        assertEquals("'runCalculation' should be correct.",
            -8628.59D, summaryData.getTotalInitialInterest().doubleValue(), 0.01);
        assertEquals("'runCalculation' should be correct.",
            0D, summaryData.getTotalPaymentsApplied().doubleValue(), 0.01);
        assertEquals("'runCalculation' should be correct.",
            -10415.51D, summaryData.getTotalBalance().doubleValue(), 0.01);
    }

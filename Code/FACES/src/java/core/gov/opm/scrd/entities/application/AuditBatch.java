...
public class AuditBatch extends IdentifiableEntity {
     ...
     * </p>
     */
    private Integer errorCountImporting;
    /**
     * <p>
     * Represents the error count processing. It is managed with a getter and setter. It may have any value. It is fully
     * mutable.
    ...
    /**
     * Getter method for property <tt>errorCountImporting</tt>.
     * @return property value of errorCountImporting
     */
    public Integer getErrorCountImporting() {
        return errorCountImporting;
    }

    /**
     * Setter method for property <tt>errorCountImporting</tt>.
     * @param errorCountImporting value to be assigned to property errorCountImporting
     */
    public void setErrorCountImporting(Integer errorCountImporting) {
        this.errorCountImporting = errorCountImporting;
    }

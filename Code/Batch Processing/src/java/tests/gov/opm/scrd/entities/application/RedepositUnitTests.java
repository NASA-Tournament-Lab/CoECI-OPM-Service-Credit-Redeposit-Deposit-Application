...
/**
 * <p>
 * Unit tests for {@link Redeposit} class.
 * </p>
 *
 * @author sparemax
 * @version 1.0
 */
public class RedepositUnitTests {
    /**
     * <p>
     * Represents the <code>Redeposit</code> instance used in tests.
     * </p>
     */
    private Redeposit instance;
    ...
    public static junit.framework.Test suite() {
        return new JUnit4TestAdapter(RedepositUnitTests.class);
    }
    ...
    public void setUp() throws Exception {
        instance = new Redeposit();
    }

    /**
     * <p>
     * Accuracy test for the constructor <code>Redeposit()</code>.<br>
    ...
    public void test_getDepositType() {
        DepositType value = DepositType.CSRS_POST_10_82_DEPOSIT;
